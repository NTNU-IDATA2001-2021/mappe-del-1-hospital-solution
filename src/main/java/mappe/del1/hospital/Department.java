...
/**
 * Represents a Department at the hospital. A department has patients and
 * employees.
 *
 * @author idatx2001
 * @version 2021-03-23
...
public class Department {
  ...
  /**
   * Creates an instance of a Department with a name given by the parameter.
   *
  ...
  /**
   * Since we override the equals()-method, we also need to override the
   * hashCode()-method.
   */
  @Override
  public int hashCode() {
  ...
  /**
   * Checks if the object provided by the parameter is equal to it self. This
   * method is overridden from the Object-class, and as such does not need
   * extra JavaDoc here.
   */
  @Override
  public boolean equals(final Object obj) {
    ...
    //By now we know that a) the objects are not the same object, and
    // b) the object must be of the class Department
  ...
  /**
   * Creates a String-representation of a Department instance for use in
   * debugging ONLY!.
   *
  ...
  /**
   * Removes a person from either the list of employees or the list of
   * patients.
   *
